...
export default function VenueMap() {
    const location = {
        ...
        mapsUrl: "https://maps.app.goo.gl/eHCTwjzNjjskDzJU6",
        // Embed URL yang benar dari Google Maps
        embedUrl: "https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3956.57244502744!2d110.53134507318745!3d-7.401708672877537!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zN8KwMjQnMDYuMiJTIDExMMKwMzInMDIuMSJF!5e0!3m2!1sid!2sid!4v1769456667380!5m2!1sid!2sid"
    };
    ...
    return (
        <div className="venue-map-section">
            ...
            <div className="venue-details-card">
                ...
                <h4 className="venue-location-name">{location.name}</h4>
                <p className="venue-address">{location.address}</p>
                <p className="venue-city">{location.city}</p>
