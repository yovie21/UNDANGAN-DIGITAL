      ...
      <div className="container">
        ...
        <div className="mempelai-grid">
          ...
          <div className="mempelai-card">
            ...
            <a
              href="https://www.instagram.com/yoviemuhammad_rizki?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mempelai-card">
            ...
            <p className="parents-name">
              Putri dari <br />
              <strong>Bapak Sahal Arifin & Almh Ibu Istiklaliyah</strong>
            </p>
            <a
              href="https://www.instagram.com/ajengayuas?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
              target="_blank"
              rel="noreferrer"
              className="social-link">
