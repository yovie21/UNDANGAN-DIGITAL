...
export default function Details() {
    const events = [
        { 
            ...
            loc: "Banjari Cukil Tengaran", 
            desc: "Mengikat janji suci dalam ikatan mitsaqan ghalizha.",
            gmaps: "https://maps.google.com/?q=Banjari+Cukil+Tengaran" 
        },
        { 
            title: "Resepsi", 
    ...
    return (
        <section id="details" className="section details-section">
            <div className="section-header" data-aos="fade-up">
                ...
                <p className="subtitle">Kami menantikan kehadiran Anda di hari bahagia kami</p>
            </div>

            <div className="container details-grid">
                {events.map((event, index) => (
                    <div className="luxury-card" key={index} data-aos={index === 0 ? "fade-right" : "fade-left"}>
